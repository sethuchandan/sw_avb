                                ...
                                int mclk_to_bclk_ratio)
{
  ...
  if (mclk_to_bclk_ratio == 1)
  {
      // output mclk straight to p_bclk
      configure_port_clock_output(p_bclk, mclk);
  }
  else
  {
      // p_bclk generated by outputs to p_bclk to divide down mclk
      configure_out_port_no_ready(p_bclk, mclk, 0);
  }
